...
DownLamp::DownLamp(double x, double y, double z) : LampPost(x, y, z){}
...
void DownLamp::draw()
{
	...
	glPushMatrix();
	glTranslated(pos->getX(), pos->getY(), pos->getZ()/2.0);
	...
	glTranslated(pos->getX(), pos->getY() + (double)CUBE_SIZE*2.0 / 3.0, pos->getZ());
