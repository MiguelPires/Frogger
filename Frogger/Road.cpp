...
void Road::draw()
{
	...
	glColor3f((float)50 / 255, (float)50 / 255, (float)50 / 255);
	...
	for (double i = -(double)HEIGHT_ROAD/2; i < (double)HEIGHT_ROAD/2; i += (double)WIDTH_CUBES / triangulos)
